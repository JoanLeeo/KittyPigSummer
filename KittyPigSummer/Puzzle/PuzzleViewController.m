...
@interface PuzzleViewController ()<UIImagePickerControllerDelegate, UINavigationControllerDelegate, PigViewControllerDelegate, SoundsTableViewControllerDelegate> {
